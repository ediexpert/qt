          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Cities <small>List of cities</small></h3>
              </div>
            ...
            <div class="row">
              ...
              <!-- <div class="col-md-12 col-sm-12 col-xs-12">
                <button id="id_add_city_btn" type="button" class="btn btn-primary" onclick="window.location.href=''">Add City</button>
              </div> -->
        ...
        <!-- /page content -->
            ...
            <script type="text/javascript">
              $(document).ready(function(){
                $('#id_add_city_btn').click(function(){
                  $('#add_city_div').show();
                })
              });
            </script>
            <script type="text/javascript">
              $(document).ready(function(){
                $('#id_save_city').click(function(){
                  var city = $('#id_city_name').val();
                  var postData = {
                    'city_name': city
                  };
                  ...
                  $.ajax({
                       type: "POST",
                       url: "<?php echo base_url(); ?>" + "index.php/cities/add",
