        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form id="loginForm" action="<?php echo base_url(); ?>index.php/user/login" method="POST">
              ...
              <?php
                if(isset($err)){
                  echo '<div class="alert">Username or Password entered is incorrect!</div>';
                }
                ?>
              <div>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Imran Bajwa</h1>
                  <p>©2016 All Rights Reserved. Imran Bajwa &copy;. Privacy and Terms</p>
                </div>
              </div>
            </form>
          </section>
