...
<!-- Flot plugins -->
<script src="<?php echo base_url(); ?>gentelella/js/flot/jquery.flot.orderBars.js"></script>
<script src="<?php echo base_url(); ?>gentelella/js/flot/date.js"></script>
<script src="<?php echo base_url(); ?>gentelella/js/flot/jquery.flot.spline.js"></script>
<script src="<?php echo base_url(); ?>gentelella/js/flot/curvedLines.js"></script>
<!-- jVectorMap -->
<script src="<?php echo base_url(); ?>gentelella/js/maps/jquery-jvectormap-2.0.3.min.js"></script>
...
<!-- jVectorMap -->
<script src="<?php echo base_url(); ?>gentelella/js/maps/jquery-jvectormap-world-mill-en.js"></script>
<script src="<?php echo base_url(); ?>gentelella/js/maps/jquery-jvectormap-us-aea-en.js"></script>
<script src="<?php echo base_url(); ?>gentelella/js/maps/gdp-data.js"></script>
<script>
$(document).ready(function(){
